...
namespace engine::data {
	...
	const std::array<Face, 6> f_faces = {
		Face::SquareFace(FaceTag::Front, vertices[1], vertices[5], NORTH, glm::vec2(0, 0), glm::vec2(1, 1)), // North
		Face::SquareFace(FaceTag::Left, vertices[6], vertices[4], WEST, glm::vec2(0, 0), glm::vec2(1, 1)), // West
		Face::SquareFace(FaceTag::Back, vertices[7], vertices[3], -NORTH, glm::vec2(0, 0), glm::vec2(1, 1)), // South
		Face::SquareFace(FaceTag::Right, vertices[0], vertices[2], -WEST, glm::vec2(0, 0), glm::vec2(1, 1)), // East
		Face::SquareFace(FaceTag::Top, vertices[2], vertices[4], UP, glm::vec2(0, 0), glm::vec2(1, 1)), // Up
		Face::SquareFace(FaceTag::Bottom, vertices[0], vertices[6], -UP, glm::vec2(0, 0), glm::vec2(1, 1)) // Down
	};
