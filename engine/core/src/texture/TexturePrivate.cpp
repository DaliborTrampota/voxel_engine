...
void gl::texture::Data2D(GLenum type, int width, int height, gl::ImageFormat format, unsigned char* data) {
    glTexImage2D(
        type,
        0,                 // mipmap level
        toGLInternalFormat(format),          // internal format
...
void gl::texture::Data3D(GLenum type, int width, int height, int depth, gl::ImageFormat format, unsigned char* data) {
    glTexImage3D(
        type,
        0,                 // mipmap level
        toGLInternalFormat(format),          // internal format
...
void gl::texture::SubData3D(GLenum type, int layer, int width, int height, int depth, gl::ImageFormat format, unsigned char* data) {
    glTexSubImage3D(
        type, 
        0, // level of detail
